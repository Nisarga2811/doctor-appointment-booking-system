<?php
	...
	include('inc\conf.php');
      ...
      //sql to insert captured values
			$query="insert into logs (name, email, pass_word) values(?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sss', $name, $email, $pass_word);
			$stmt->execute();
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="form-group row mt-2">
                                ...
                                <div class="col-md-8">
                                    <input type="password" class="form-control" name="pass_word" autocomplete="none" placeholder="Enter password">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mt-2">
                                <div class="col-md-4"></div>
                                    <div class="col-md-8">
                                    <div class="col-6"><input type="submit" name ="cl_register" class="btn btn-danger" value ="Register"></div>

                                        <a href="index.php"><button type="button" class="btn btn-primary">
                                            Home
                                        </button> </a>  
                                        <p class="text-black mt-2 mb-2">I already have an account <a href="login.php">Login</a></p>                        
                                    </div>
                                </div>
                        </form>
                    </div>
