<?php
    ...
    check_login();
		if(isset($_POST['res_register']))
		{
			$email=$_POST['email'];
			$password=sha1(md5($_POST['password']));

      //sql to insert captured values
			$query="insert into res_logs ( email, password) values(?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ss',$email, $password);
			$stmt->execute();
...
<head>
    ...
    <title>Create Respition password</title>
        ...
        <div class="container">
            <div class="row justify-coctent-enter">
                <div class="card" style="width: 700px;">
                    <div class="card-login" style="padding-left: 300px; font-size: 20px;">Create Resiption Password</div>
                    <div class="card-body">
                        <hr>
                        <form method="POST">
                            ...
                            <div class="form-group row mt-2">
                                <div class="col-md-4"></div>
                                    <div class="col-md-8">
                                    <div class="col-6"><input type="submit" name ="res_register" class="btn btn-danger" value ="Register"></div>
                                        <div>
                                        <a href="ad-index.php"><button type="button" class="btn btn-primary">
                                            Home
                                        </button> </a></div>
                                        <a href="res-view.php"><button type="button" class="btn btn-primary">
                                            Back
                                        </button> </a>
                                    </div>
                                </div>
